...
namespace StephSoft
{
    public partial class frmSeleccionarCliente : Form
    {
        ...
        //public frmSeleccionarCliente(string Texto)
        //{
        //    try
        //    {
        //        InitializeComponent();
        ...
        private void IniciarForm()
        {
            try
            {
                ...
                //{
                //    this.txtBusqueda.Text = this.TextoBusqueda;
                //    this.BuscarRegistros(this.TextoBusqueda);
                //}
        ...
        private Cliente ObtenerDatos(int Fila)
        {
            try
            {
                ...
                if (Fila < this.dgvClientes.Rows.Count)
                {
                    ...
                    Aux.IDTarjeta = this.dgvClientes.Rows[Fila].Cells["IDTarjeta"].Value.ToString();
                    Aux.FolioTarjeta = this.dgvClientes.Rows[Fila].Cells["NumTarjeta"].Value.ToString();
                    Aux.Padecimientos = this.dgvClientes.Rows[Fila].Cells["Padecimientos"].Value.ToString();
                    decimal Saldo = 0;
                    decimal.TryParse(this.dgvClientes.Rows[Fila].Cells["Saldo"].Value.ToString(), out Saldo);
                    Aux.SaldoMonedero = Saldo;
                }
                return Aux;
            }
            catch (Exception ex)
