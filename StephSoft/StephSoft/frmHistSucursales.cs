...
namespace StephSoft
{
    public partial class frmHistSucursales : Form
    {
        ...
        public frmHistSucursales(Cliente Datos)
        {
            try
            {
                InitializeComponent();
        ...
        private void CargarGridPedidoDetalle()
        {
            try
            {
                this.dgvHistorialSucursales.AutoGenerateColumns = false;
                this.dgvHistorialSucursales.DataSource = null;
                this.dgvHistorialSucursales.DataSource = this.ListadeCitasXClientes;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        private Cliente CargarGribMobiliarioDetalle()
        {
            try
            {
                ...
                return CNNeg.ObtenerHistoriaSucursales(DatosAux);
            }
            catch (Exception ex)
            {
                throw ex;
