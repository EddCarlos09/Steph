...
namespace StephSoft
{
    public partial class frmHistCompras : Form
    {
        ...
        public frmHistCompras(Cliente Datos)
        {
            try
            {
                InitializeComponent();
        ...
        private void CargarGridPedidoDetalle()
        {
            try
            {
                this.dgvHistorialCompras.AutoGenerateColumns = false;
                this.dgvHistorialCompras.DataSource = null;
                this.dgvHistorialCompras.DataSource = this.ListadeCitasXClientes;
            }
            catch (Exception ex)
            {
                throw ex;
