    ...
    public partial class frmNuevoProducto : Form
    {
        ...
        private void IniciarDatos()
        {
            try
            {
                ...
                this.txtCantidadMetrica.Text = string.Empty;
        ...
        private Producto ObtenerDatos()
        {
            try
            {
                ...
                int CantidadMetrica = 0, CantidadMayoreo = 0;
        ...
        private byte[] ObtenerImagenByte()
        {
            try
            {
                ...
                Image ImagenComp = ComprimirImagen.ResizeImage(this.pbImagen.Image, 100, 100, Formato);
        ...
        private Image ObtenerImagen()
        {
            try
            {
                ...
                ImageFormat Formato = ImageFormat.Jpeg;
                return ComprimirImagen.ResizeImage(this.pbImagen.Image, 100, 100, Formato);
            }
            catch (Exception ex)
            {
                throw ex;
