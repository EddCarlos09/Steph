...
namespace CreativaSL.Dll.StephSoft.Global
{
    public class Pedido
    {
        ...
        private string _IDPedidoRecepcion;

        public string IDPedidoRecepcion
        {
            get { return _IDPedidoRecepcion; }
            set { _IDPedidoRecepcion = value; }
        }

        private string _IDPedidoSurtido;

        public string IDPedidoSurtido
        {
            get { return _IDPedidoSurtido; }
            set { _IDPedidoSurtido = value; }
        }
